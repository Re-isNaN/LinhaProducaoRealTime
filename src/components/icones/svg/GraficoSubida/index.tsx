...
export function IconGraficoSubida({ height, width, color }: IPropsIcon) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill={color || '#000'} width={`${width}px`} height={`${height}px`} version="1.1" id="Capa_1" viewBox="0 0 318.996 318.996" xmlSpace="preserve">
            <g>
                <g id="Layer_5_66_">
                    <g>
                        <g>
