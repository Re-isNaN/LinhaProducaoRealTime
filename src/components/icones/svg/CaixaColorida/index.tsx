...
export function IconCaixaColorida({ width, height }: IPropsIcon) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={`${width}px`} height={`${height}px`} viewBox="0 0 100 100"><path fill-rule="evenodd" clip-rule="evenodd" fill="#FBF063" d="M7 22L50 0l43 22-43 21.001L7 22z" />
